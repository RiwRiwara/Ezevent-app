...
function AuthActionLayout({ handleClose, showActionsheet, destination }) {
          ...
          >
            ...
            >
              <View alignItems="center">
                <AuthSignInEmailAction destination={destination} handleCloseCallback={handleClose} />
...
export default AuthActionLayout;
